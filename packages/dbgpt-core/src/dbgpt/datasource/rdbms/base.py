...
class RDBMSConnector(BaseConnector):
    ...
    def _sync_tables_from_db(self) -> Iterable[str]:
        ...
        # This only refreshes the in-memory table-name list. The vector store
        # (DBSchemaAssembler output) is NOT refreshed here — that lives in the
        # serve layer (ConnectorManager) which compares old vs. new table sets
        # after a cache rebuild and triggers DBSummaryClient.db_summary_embedding
